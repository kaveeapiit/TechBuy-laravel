    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                            <span class="inline-flex rounded-md">
                                <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-secondary-700 bg-white hover:text-primary-600 hover:bg-primary-50 focus:outline-none focus:bg-primary-50 active:bg-primary-100 transition ease-in-out duration-150">
                                    {{ Auth::user()->name }}
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <!-- Mobile Cart Icon -->
                @auth
                <a href="{{ route('cart') }}" class="relative inline-flex items-center p-2 me-2 text-secondary-600 hover:text-primary-600 transition duration-200">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.5 9.5M15 7l-1.5 9.5"></path>
                    </svg>
                    @livewire('cart-count')
                ...
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-secondary-600 hover:text-primary-600 hover:bg-primary-50 focus:outline-none focus:bg-primary-50 focus:text-primary-600 transition duration-150 ease-in-out">
